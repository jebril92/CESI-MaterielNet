...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Location = System::Drawing::Point(32, 172);
			...
			// dateTimePicker1
			// 
			this->dateTimePicker1->Location = System::Drawing::Point(155, 167);
			...
			this->textBoxNumTel->Location = System::Drawing::Point(121, 206);
			...
			this->labelNumTel->Location = System::Drawing::Point(36, 204);
			...
			this->textBoxadressemail->Location = System::Drawing::Point(121, 239);
			...
			this->labelAdresseMail->Location = System::Drawing::Point(27, 239);
			...
			this->comboBoxSexe->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->comboBoxPays->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->label8->Location = System::Drawing::Point(37, 271);
			...
			this->comboBoxsuperieur->Location = System::Drawing::Point(121, 267);
			this->comboBoxsuperieur->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			this->comboBoxsuperieur->Name = L"comboBoxsuperieur";
			this->comboBoxsuperieur->Size = System::Drawing::Size(233, 24);
...
#pragma endregion
	...
	{
		try {
			if (comboBoxsuperieur && textBoxNom && textBoxPrenom && textBoxNumTel && textBoxadressemail && comboBoxSexe && comboBoxPays && textBoxVille && textBoxCP && textBoxNumRue && textBoxRue && textBoxEtage && textBoxResidence->Text == "")
			{
			...
			else
			{
				...
				cmd->ExecuteReader();
				MessageBox::Show("Le Personnel : " + nom + " " + prenom + " a été ajouté(e) avec succès ! ");
			}
			}
		catch (Exception^ ex)
		{
